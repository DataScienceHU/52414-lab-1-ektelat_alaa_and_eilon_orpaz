...
eco_data_new <- head(eco_data_new , as.integer(265*0.9))
plot(x= eco_data_new$pop65, 
     y= log(eco_data_new$GDP_per_capita) , 
     col = "black" , 
     main = "log GDP per capita VS old population" ,
...
points(x=chooseorder$pop65, y= chooseorder$sdeaths, main= "italy", 
    ...
    xlim=c(15,28),
    col = ifelse(chooseorder$sdeaths <= 15,'green','red'))
